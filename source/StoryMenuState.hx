...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		if (cleanfont_isenabled)
		{
			...
			scoreText.setFormat(Paths.font("coolvetica.ttf"), 32);
			scoreText.color = 0xFFF9CF51;
			scoreText.alpha = 0.7;

			txtWeekTitle = new FlxText(FlxG.width * 0.7, 10, 0, "", 32);
			txtWeekTitle.setFormat(Paths.font("coolvetica.ttf"), 32, FlxColor.WHITE, RIGHT);
			txtWeekTitle.alpha = 0.7;

			rankText = new FlxText(0, 690);
		...
		//var yellowBG:FlxSprite = new FlxSprite(0, 56).makeGraphic(FlxG.width, 400, FlxColor.PURPLE);
		//yellowBG.alpha = 0.7;
	...
	function updateText()
	{
		...
		switch (grpWeekCharacters.members[0].animation.curAnim.name)
		{
			...
			case 'tankman':
				grpWeekCharacters.members[0].offset.set(50, -50);
