...
class Character extends FlxSprite
{
	...
	var jamey_isenabled:Bool = false;
	var catgirl_isenabled:Bool = false;

	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		jamey_isenabled = config.getjamey();
		catgirl_isenabled = config.getcatgirl();
		super(x, y);
		...
		switch (curCharacter)
		{
			case 'gf':
				// GIRLFRIEND CODE
			if (catgirl_isenabled)
			{
				tex = Paths.getSparrowAtlas('CATGF_assets');
				frames = tex;
			...
			if (catgirl_isenabled)
			{
				tex = Paths.getSparrowAtlas('catgfCar');
				frames = tex;
			...
			case 'picoSpeaker':
				...
				tex = Paths.getSparrowAtlas('tank/picoSpeaker', 'week7');
				frames = tex;
			...
			{
				frames = Paths.getSparrowAtlas('tank/gfTankman','week7');
			...
			case 'nobody':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('rolled/nobody','shared');
				frames = tex;
				animation.addByPrefix('idle', 'nobody idle dance', 24);
				animation.addByPrefix('singUP', 'nobody Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'nobody Sing Note RIGHT', 24);
				animation.addByPrefix('singDOWN', 'nobody Sing Note DOWN', 24);
				animation.addByPrefix('singLEFT', 'nobody Sing Note LEFT', 24);
			...
			case 'garcello':
				...
				tex = Paths.getSparrowAtlas('garcello_assets', 'week9');
				frames = tex;
			...
			case 'garcellotired':
				...
				tex = Paths.getSparrowAtlas('garcellotired_assets','week9');
				frames = tex;
			...
			case 'garcellodead':
				...
				tex = Paths.getSparrowAtlas('garcellodead_assets','week9');
				frames = tex;
				animation.addByPrefix('idle', 'garcello idle dance', 24);
				animation.addByPrefix('singUP', 'garcello Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'garcello Sing Note RIGHT', 24);
			...
			case 'garcelloghosty':
				// GARCELLO DEAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('garcelloghosty_assets','week9');
				frames = tex;
				animation.addByPrefix('idle', 'garcello idle dance', 24);
				animation.addByPrefix('singUP', 'garcello Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'garcello Sing Note RIGHT', 24);
			...
			case 'bf':
			{
				if (jamey_isenabled)
				{
				var tex = Paths.getSparrowAtlas('Jamey','shared');
				frames = tex;
			...
			case 'rick':
			{
				var tex = Paths.getSparrowAtlas('rolled/rick_assets','shared');
				frames = tex;
				animation.addByPrefix('idle', 'rick idle dance', 24, false);
				animation.addByPrefix('singUP', 'rick NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'rick NOTE LEFT0', 24, false);
				animation.addByPrefix('singRIGHT', 'rick NOTE RIGHT0', 24, false);
				animation.addByPrefix('singDOWN', 'rick NOTE DOWN0', 24, false);
				animation.addByPrefix('singUPmiss', 'rick NOTE UP MISS', 24, false);
				animation.addByPrefix('singLEFTmiss', 'rick NOTE LEFT MISS', 24, false);
				animation.addByPrefix('singRIGHTmiss', 'rick NOTE RIGHT MISS', 24, false);
				animation.addByPrefix('singDOWNmiss', 'rick NOTE DOWN MISS', 24, false);
				animation.addByPrefix('hey', 'rick HEY', 24, false);
			...
			case 'bf-pixel':
				if (jamey_isenabled)
				{
				frames = Paths.getSparrowAtlas('jameyPixel','shared');
			...
			case 'bf-holding-gf':
				...
				{
				frames = Paths.getSparrowAtlas('tank/bfAndGF', 'week7');
			...
			case 'bf-holding-gf-dead':
				...
				frames = Paths.getSparrowAtlas('tank/bfHoldingGF-DEAD', 'week7');
			...
			case 'tankman':
				tex = Paths.getSparrowAtlas('tank/tankmanCaptain','week7');
				frames = tex;
			...
			case 'gman':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('sb/DADDY_DEAREST','week8');
				frames = tex;
				animation.addByPrefix('idle', 'Dad idle dance', 24);
				animation.addByPrefix('singUP', 'Dad Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Dad Sing Note RIGHT', 24);
				...
				case 'human':
					...
					tex = Paths.getSparrowAtlas('sb/human_assets','week8');
					frames = tex;
					animation.addByPrefix('idle', 'human idle', 24);
					animation.addByPrefix('singUP', 'human up', 24);
					animation.addByPrefix('singRIGHT', 'human right', 24);
					animation.addByPrefix('singDOWN', 'human down', 24);
					animation.addByPrefix('singLEFT', 'human left', 24);
	
					addOffset('idle');
					addOffset("singUP", 72, 12);
					addOffset("singRIGHT", 31, 0);
					addOffset("singLEFT", 152, 0);
					addOffset("singDOWN", 65, -52);
	
					playAnim('idle');
					
				case 'ragdoll':
				
					tex = Paths.getSparrowAtlas('sb/ragdoll_assets','week8');
					frames = tex;
				...
				case 'buddy':
					...
					tex = Paths.getSparrowAtlas('sb/buddy_assets','week8');
					frames = tex;
					animation.addByPrefix('idle', 'idle', 24);
					animation.addByPrefix('singUP', 'up', 24);
					animation.addByPrefix('singRIGHT', 'right', 24);
				...
				case 'bonzi':
					...
					tex = Paths.getSparrowAtlas('sb/bonzi_assets','week8');
					frames = tex;
